...
hangman = int(input("Welcome to Hangman Game. Press 1 to start "))

while hangman == 1:
    letter = input(print("You have 6 lifes, choose a letter"))
    if letter == word
    

hangman = int(input("Thankyou to play Hangman. Do you want to try again? Press 1 to start "))
